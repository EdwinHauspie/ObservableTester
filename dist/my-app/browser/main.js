...
var AppComponent = /* @__PURE__ */ (() => {
  const _AppComponent = class _AppComponent {
    constructor() {
      this.subject1 = new BehaviorSubject(1);
      this.subject2 = new BehaviorSubject(2);
      this.subject3 = new BehaviorSubject(3);
    }
    ngOnInit() {
      let obs = of(0).pipe(switchMap((_) => this.subject1.pipe(tap((nr) => console.log("subject " + nr)))), switchMap((_) => this.subject2.pipe(tap((nr) => console.log("subject " + nr)))), switchMap((_) => this.subject3.pipe(tap((nr) => console.log("subject " + nr)))));
      obs.subscribe({
  ...
  _AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    decls: 11,
    vars: 0,
    consts: [[1, "main"], [3, "click"]],
    template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "main", 0);
        \u0275\u0275text(1, " Hello World! ");
        \u0275\u0275elementStart(2, "div")(3, "button", 1);
